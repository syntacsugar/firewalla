...
function install_dependencies() {
	...
	apt_pkg_list="wget net-tools curl redis-server iptables ca-certificates nmap dsniff bluetooth bluez libbluetooth-dev libudev-dev nodejs openvpn easy-rsa cron ntpdate ipset dhcpdump dnsmasq dnsutils nbtscan"
